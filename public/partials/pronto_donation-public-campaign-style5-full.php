				...
				<div class="pd-col s12">
					<?php if( isset($pronto_donation_user_info['user_comment_option']) && $pronto_donation_user_info['user_comment_option'] != 'hide'): ?>
						<div class="pd-container-group clearfix">
							<div class="pd-col s12">
								<div class="pronto-donation-group">
									<textarea class="<?php echo $this->campaignOption->InputFieldClass ?>" placeholder="Additional Comments" name="comment" rows="5" <?php $this->class->pronto_donation_is_required($pronto_donation_user_info['user_comment_option']) ?>></textarea>
								</div>
							</div>
						</div>
					<?php endif; ?>
